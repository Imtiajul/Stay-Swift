...
const HotelListPage = async({searchParams: {destination, checkin, checkout, category, amenities}}) => {
        ...
        <>
            ...
            <section className="py-12">
                <div className="container grid grid-cols-12">
                    <Filter />
                    <HotelList category={refineCategory(category)} destination={destination} checkin={checkin} checkout={checkout} amenities={refineCategory(amenities)} />
                </div>
            </section>
        </>
    );
